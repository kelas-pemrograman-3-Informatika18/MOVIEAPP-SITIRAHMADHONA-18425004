  ...
  <q-page padding>
    <div class="row q-mb-md col-gutter-md">
      <div class="col-md-12 col-xs-12 col-lg-12">
        <div class="row">
          ...
          <div class="col">
            <q-banner inline-actions class="text-purple-5">
        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            ...
            <q-td key="aksi" :props="props">
              <q-btn label="Detail" @click="openDetail(props.row)" color="purple-5" unelevated/>
    ...
    >
      <q-card style="width: 700px; max-width: 80vw;">
        ...
        <q-card-actions align="right" class="bg-white text-purple-5">
