<template>
    <q-layout class="bg-purple-5" view="lHh Lpr Lff">
      <q-page-container>
        <q-page padding class="row items-center justify-center">
            <div class="full-width row">
              <div class="col-md-6 offset-md-3 col-xs-12 q-pa-md">
                  <q-card flat class="text-purple-5">
                      <div class="row">
                          <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-8 offset-2">
                                    <q-img src="../../statics/BTS.jpg"></q-img>
                                </div>
                            </div>
                          </div>
                          <div class="col md-6">
                            <q-card-section>
                              ...
                              <q-form @submit="login">
                                ...
                                <q-card-section>
                                    <q-btn label="Login" type="submit" unelevated color="purple-5" class="full-width" />
